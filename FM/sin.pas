...
const
  SIN_LG_N_SAMPLES = 10;
  SIN_N_SAMPLES    = (1 shl SIN_LG_N_SAMPLES);
...
var
  sintab           : array[0..(SIN_N_SAMPLES shl 1)-1] of integer;
...
begin
  ...
  c      := floor(cos(dphase) * (1  shl  30) + 0.5);
  ...
  for i := 0 to SIN_N_SAMPLES - 1-1 do begin
