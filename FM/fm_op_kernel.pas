...
TParamList= array[0..5] of FmOpParams;
...
class procedure FmOpKernel.compute(output, input : Pinteger; phase0, freq, gain1, gain2 : integer; add : Boolean);
var
  dgain, gain, phase, i, y, y1: integer;
begin
...
class procedure FmOpKernel.compute_pure(output : Pinteger; phase0, freq, gain1, gain2 : integer; add : Boolean);
var
  dgain, gain, phase, i, y, y1 : integer;
begin
  dgain := (gain2 - gain1 + (N  shr  1))  shr  LG_N;
...
class procedure FmOpKernel.compute_fb(output : Pinteger; phase0, freq, gain1, gain2 : integer;var fb_buf : TFeedbackBuffer; fb_shift : integer; add : Boolean);
var
  dgain, 
  gain, 
  phase, 
